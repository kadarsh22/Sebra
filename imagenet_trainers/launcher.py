...
def parse_args():
    ...
    parser.add_argument("--data_root", type=str, default="/vol/research/project_storage/data")
    parser.add_argument(
        "--feature_extractor",
        type=str,
    ...
    parser.add_argument("--batch_size_stage2", default=128, type=int)
    ...
    # LLE
    parser.add_argument("--num_dist_shift", type=int, default=4)  # Original, Texture, BG, Watermark
    ...
    parser.add_argument('--p_critical', type=float, default=0.1)
    parser.add_argument('--gap', type=float, default=4, help="how much rank gap should be added to positive sample")
...
def main():
    ...
    if args.slurm_partition is not None:
        ...
        executor = submitit.AutoExecutor(
            ...
            python = '/mnt/fast/nobackup/users/ak03476/sebra/bin/python'
        )
